...
<br>
<h2>Необходимо заполнить все поля!</h2>
<br><br>
...
<form class="form-horizontal" action="registration_check.php" method="post">
  ...
  <div class="control-group">
   ...
   <div class="control-group">
    <label class="control-label" for="inputcity">Адрес</label>
    <div class="controls">
      ...
      <p><small>* Указать полный фактический адрес на который будет произведена доставка. Например: Московская обл, г.Москва, ул.Ленина 1. индекс 123456</small></p>
    </div>
  </div>
         <div class="control-group">
    <label class="control-label" for="inputinn">ИНН</label>
    <div class="controls">
      <input type="text" id="inputinn" name="inn" placeholder="ИНН">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="inputogrn" name="ogrn" placeholder="ИНН">
...
<script>
  $(document).ready(function(){
        ...
        yourfamil=$(this).attr('value');
        var pattern = /^[0-9 a-zа-я,.;-№\-]{2,200}$/i;
        ...
        function button_activator(){
            if (($('#spaninputli').hasClass('label-success')) && ($('#spaninputName').hasClass('label-success')) && ($('#spaninputotch').hasClass('label-success')) && ($('#spaninputfamil').hasClass('label-success')) && ($('#span_email').hasClass('label-success')) && ($('#span_pw').hasClass('label-success'))  && ($('#span_pw2').hasClass('label-success')) && ($('#spaninputaddress').hasClass('label-success')) && ($('#spaninputtel').hasClass('label-success'))) { $('#reg_button').removeClass('disabled'); }
