		...
		if ('ckeditor' == this.returnTo) {
			if ('undefined' != typeof(params.editor)) {
				...
				for (var i in type) {
					...
					params.editor.config['filebrowser' + type[i] + 'BrowseUrl']	= this.path + '/index.php?type=' + type[i].toLowerCase() + '&connector=' + this.connector + '&lang=' + this.lang + '&returnTo=' + this.returnTo + '&skin=' + this.skin + '&contextmenu=' + this.contextmenu;
		...
		switch(returnTo) {
			...
			case 'tinymce':
			    tinyMCE.activeEditor.windowManager.open({
					...
					//url: 'http://www.ladystyle.su/AjexFileManager/index.html?type=' + type.toLowerCase() + '&connector=' + this.connector + '&returnTo=' + this.returnTo + '&lang=' + this.lang + '&skin=' + this.skin + '&contextmenu=' + this.contextmenu,
			        width: this.width,
			        height: this.height,
			        inline: 'yes',
			        close_previous: 'no'
