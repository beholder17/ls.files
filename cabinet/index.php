...
<div class="span10">
<h1>Личный кабинет оптового покупателя</h1>
<br>
<!--<h2>Анкета</h2>-->
<?php 
$anketa = new users();
...
if  ($anketa->level=='1') echo "<div class=\"alert alert-info\">Ваша учетная запись еще не активирована, но менеджер уже уведомлен! Он буквально летит к компьютеру чтобы открыть Ваш личный кабинет! :)</div>";
if  ($anketa->level=='2') echo "<div class=\"alert alert-success\">Учетная запись активирована!</div>";
