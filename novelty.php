...
define("KEY_WORDS", "Обновление коллекции, женская одежда, осень зима 2014, новый сезон, одежда от производителя оптом, одежда оптом не дорого");
define("DESCRIPTION", "Новая коллекции женской одежды осень-зима 2014 российского производства! Для опта доступны: платья, блузки, брюки и другие категории товаров. Доставка по всей России! ");
$CAT_TYPE="novelty";
?>
<?php
...
<div class="row">
    ...
    <div class="span10">
		...
		$last_date = "2015-06-08";
		$last_date2	= "2015-04-03";
        ...
        while ($r = mysql_fetch_array($result)) {
			...
			$query2 = "SELECT * FROM im_catalog WHERE (date='$last_date' AND category='$r[0]' AND `show`='1') OR (date='$last_date2' AND category='$r[0]' AND `show`='1');";
